...
export default function AnuncioForm() {
  ...
  async function handleSubmit(e?: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const { keywords, ...restOfData } = formData;
      if (id) {
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-20 animate-in fade-in duration-300">
      ...
      <section className="jtd-glass p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-muted-foreground uppercase">Custo do Produto (R$)</label>
            <input 
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-muted-foreground uppercase">Taxa Marketplace (%)</label>
            <input 
              type="number"
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-muted-foreground uppercase">Frete (R$)</label>
            <input 
              type="number" step="0.01"
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-muted-foreground uppercase">Embalagem (R$)</label>
            <input 
              type="number" step="0.01"
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-muted-foreground uppercase">Transporte (R$)</label>
            <input 
              type="number" step="0.01"
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-muted-foreground uppercase">Margem de Lucro (%)</label>
            <input 
              type="number"
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-bold text-muted-foreground uppercase">Falso Desconto (%)</label>
            <input 
              type="number"
        ...
        <div className="bg-black/40 border border-primary/20 rounded p-6 space-y-4">
          <div className="grid grid-cols-2 gap-y-2 text-xs">
            ...
            <span className="text-muted-foreground">Taxa MK (R$):</span>
            <span className="text-right text-foreground">R$ {calcs.mkFeeReal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
            
            <span className="text-muted-foreground">Imposto (R$):</span>
            <span className="text-right text-foreground">R$ {calcs.taxReal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
            
            <span className="text-muted-foreground">Lucro (R$):</span>
            <span className="text-right text-foreground font-bold text-lime-500">R$ {calcs.lucroReal.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
          </div>
          
          <div className="pt-4 border-t border-primary/10 grid grid-cols-2 items-end">
            <div>
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Preço de Venda</p>
              <p className="text-2xl font-black text-cyan-400">R$ {calcs.venda.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
            </div>
            <div className="text-right">
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider">Preço Riscado</p>
